...
public class Ejecutable{
	...
	public void menu(){
		...
		do{
			...
			System.out.println("6) Consultar composicion de inventario");
			System.out.println("7) Consultar el producto con mas unidades");
			...
			switch(option){
				...
				case 6:
				consultarComposicionInventario();
				break;
				case 7:
	...
	public void registrarJuego(){
		...
		System.out.println("Seleccione el genero del juego");
	...
	public void consultarComposicionInventario(){
